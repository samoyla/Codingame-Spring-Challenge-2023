...
while (1) {
    vector<vector<int>> all_res_paths = find_targets(cells, my_bases[0]);
    vector<vector<int>> egg_paths = find_targets(cells, my_bases[0], 1);
    vector<vector<int>> crist_paths = find_targets(cells, my_bases[0], 2);
